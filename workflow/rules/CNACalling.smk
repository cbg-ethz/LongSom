...
rule all_cnv:
    input:
        expand('featurecount/{id}.counts.formated.txt', id = IDS),
        expand(f"{OUTDIR}/InferCNV/InferCNV/{{id}}/infercnv.17_HMM_predHMMi6.leiden.hmm_mode-subclusters.png", id = IDS),
